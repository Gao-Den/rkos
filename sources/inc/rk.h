 ...
 *
 ***************************************************************************************/
#define TASK_POOL_MAX_SIZE                  (PORT_TASK_POOL_MAX_SIZE)
 ...
 *
 ***************************************************************************************/
#define RK_PURE_MSG_POOL_SIZE               (PORT_PURE_MSG_POOL_SIZE)
#define RK_COMMON_MSG_DATA_SIZE             (64)
#define RK_COMMON_MSG_POOL_SIZE             (PORT_COMMON_MSG_POOL_SIZE)
#define RK_DYNAMIC_MSG_POOL_SIZE            (PORT_DYNAMIC_MSG_POOL_SIZE)

/***************************************************************************************
 * DEFINITION: timer
 *
 ***************************************************************************************/
#define TIMER_TASK_STACK_SIZE               (PORT_TIMER_TASK_STACK_SIZE)
#define TIMER_TASK_QUEUE_MAX_SIZE           (PORT_TIMER_TASK_QUEUE_MAX_SIZE)
#define TIMER_EVENT_POOL_MAX_SIZE           (PORT_TIMER_EVENT_POOL_MAX_SIZE)

/***************************************************************************************
 * DEFINITION: heap memory
 *
 ***************************************************************************************/
#define HEAP_BUFFER_MAX_SIZE                (PORT_HEAP_BUFFER_MAX_SIZE)
